...
| [`agent-audit-token-metrics.md`](agent-audit-token-metrics.md) | Token efficiency profiling: baseline vs error-path runs, COR/CPI/STC metrics, interpretation guide |
