...
| `agent-audit` | AI-agent workflow reproducibility | run manifests ("lockfile"), config drift diff, multidimensional outcome fingerprint, decision provenance, secret redaction |
